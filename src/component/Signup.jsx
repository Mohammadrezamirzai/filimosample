          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div className="text-sm">
                <label htmlFor="agreeToTerms" className="text-gray-300 cursor-pointer">
                  ...
                  <a href="#" className="text-green-400 px-1 hover:text-green-300 mr-1 transition-colors duration-200 cursor-pointer">
                    فیلیمو
                  </a>
            ...
            <div className="text-center">
              <p className="text-gray-400 text-sm">
                ...
                <a href="#" className="text-green-400 hover:text-green-300 font-medium transition-colors duration-200 cursor-pointer">
                  ورود به حساب
                </a>
              </p>
            </div>
