...
import consoleIcon from '../../assets/svg/console.svg';
import playBtnIcon from '../../assets/svg/play-btn.svg';
      ...
      <div className="w-full md:w-1/2 flex flex-col items-center justify-center">
        ...
        <div className="flex flex-col gap-4 w-full">
          <div className="flex items-center justify-center gap-3 group">
            ...
            <img src={tvIcon} width="32" height="32" alt="tv" />
          </div>
          ...
          <div className="flex items-center justify-center gap-3 group">
            ...
            <img src={tabletIcon} width="32" height="32" alt="tablet" />
          </div>
          ...
          <div className="flex items-center justify-center gap-3 group">
            ...
            <img src={consoleIcon} width="32" height="32" alt="console" />
          </div>
        ...
        <button className="flex items-center gap-2 bg-gradient-to-r from-green-400 to-green-600 hover:from-green-500 hover:to-green-700 px-8 py-3 mt-10 rounded-xl shadow-lg duration-200 cursor-pointer text-white font-extrabold text-lg transition-all">
          خرید اشتراک و تماشا
          <img src={playBtnIcon} width="18" height="18" alt="play" />
        </button>
      </div>
    </section>
  );
