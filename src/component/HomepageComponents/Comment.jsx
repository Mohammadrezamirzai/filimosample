...
export default function Comment({ name,description }) {
  return (
    <div className="mt-8 mx-auto w-[200px] rounded-2xl border border-gray-700 bg-white/10 backdrop-blur-md shadow-lg flex flex-col items-center space-y-4 h-[220px] transition-transform duration-300 hover:scale-105">
