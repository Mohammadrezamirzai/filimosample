      ...
      <div className="relative max-w-md w-full">
        ...
        <div className="bg-white/5 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/10 p-8 space-y-8">
          ...
          <div className="text-center">
            ...
            <p className="text-gray-300 text-sm">به حساب کاربری خود وارد شوید</p>
          </div>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-sm">
                <a href="#" className="text-green-400 hover:text-green-300 transition-colors duration-200 font-medium cursor-pointer">
                  فراموشی رمز عبور
                </a>
              </div>
            </div>
