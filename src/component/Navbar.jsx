      ...
      <header className="flex px-8  z-100 fixed top-0 left-0 bg-black w-full h-[50px]">
        <div className="w-[25%] flex items-center space-x-2 ">
          <button
            ...
            className="flex font-bold  text-white text-xs h-[30px] px-2 items-center bg-gray-700 rounded-sm shadow-md duration-200 cursor-pointer hover:bg-gray-800"
          >
            ثبت نام
          </button>
          <button
            onClick={() => onNavigate && onNavigate("login")}
            className="flex font-bold  text-white text-xs h-[30px] px-2 items-center bg-blue-600 rounded-sm shadow-md duration-200 cursor-pointer hover:bg-blue-700"
          >
            ورود
          </button>
          <button
            onClick={() => setShowSubscription(true)}
            className="flex font-bold  text-white text-xs h-[30px]  px-2 items-center bg-green-500 rounded-sm shadow-md duration-200 cursor-pointer hover:bg-green-800"
          >
            خرید اشتراک
          </button>
        </div>
